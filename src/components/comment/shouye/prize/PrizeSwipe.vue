<template>
	...
	<div>
		<swiper :options="swiperOption" ref="mySwiper" @someSwiperEvent="callback" class="my-swipe">
			<!-- slides -->
			<swiper-slide class="my-swiper-slide my-first-swipe">
				<img class="swipe-img" src="https://img.alicdn.com/tps/TB1ZS5EJXXXXXaJXVXXXXXXXXXX-730-300.jpg" alt="" style="opacity: 1;">
...
<script>
	//导入轮播组件 vue-awesome-swiper
	//因为这不是全局导入，只是按需导入 所以要在所需组件中导入注册
		...
		data() {
			return {
				swiperOption: {
					...
					controller: {
					  control: '#swiper-container2', //控制Swiper1
					},
